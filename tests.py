...
def test_default_policy_simple_win(default_policy):
    ...
    try:
        ...
        print "Exception occured testing default_policy_win on board:"
        board.visualize()
        raise ex
...
def test_default_policy_simple_loss(default_policy):
    ...
    try:
        ...
        print "Exception occured testing default_policy_loss on board:"
        board.visualize()
        raise ex
...
def test_default_policy_termination(default_policy):
    ...
    try:
        ...
        print "Exception occured testing default_policy_ter on board:"
        board.visualize()
        raise ex
